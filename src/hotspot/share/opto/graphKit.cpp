...
Node* GraphKit::compress_string(Node* src, const TypeAryPtr* src_type, Node* dst, Node* count) {
  ...
  const TypePtr* in_adr_type = nullptr;
  Node* mem = capture_memory(in_adr_type, src_type, TypeAryPtr::BYTES);
  StrCompressedCopyNode* str = new StrCompressedCopyNode(control(), mem, in_adr_type, src, dst, count);
...
void GraphKit::inflate_string(Node* src, Node* dst, const TypeAryPtr* dst_type, Node* count) {
  ...
  const TypePtr* in_adr_type = nullptr;
  Node* mem = capture_memory(in_adr_type, TypeAryPtr::BYTES, dst_type);
  StrInflatedCopyNode* str = new StrInflatedCopyNode(control(), mem, dst_type, in_adr_type, src, dst, count);
